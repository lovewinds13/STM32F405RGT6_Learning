...
#define	OLED_GPIO_CLK				RCC_AHB1Periph_GPIOA
...
extern void oled_dis_num(uint8_t x, uint8_t y, uint32_t num, uint8_t len, uint8_t size_num, uint8_t dis_mode);
